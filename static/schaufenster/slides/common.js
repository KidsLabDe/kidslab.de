...
const COURSES = [
  {
    ...
    image: 'assets/course-minnimaker-1.webp',
  ...
  },
  {
    ...
    image: 'assets/course-lego-1.webp',
  ...
  },
  {
    ...
    image: 'assets/course-lego-3.webp',
...
const PROJECTS = [
  {
    ...
    image: 'assets/gameslab-winners.webp',
  ...
  },
  {
    ...
    image: 'assets/minecraft-city.webp',
    url: 'kidslab.de/demokratie-in-minecraft/',
  },
];

const GALLERY = [
  'assets/course-minnimaker-2.webp',
  'assets/course-lego-2.webp',
  'assets/course-minnimaker-3.webp',
  'assets/gameslab-workshop.webp',
  'assets/course-lego-3.webp',
  'assets/gp-02.webp',
];
...
const QR_IMAGES = {
  'kidslab.de/kurse/minnimaker-nachmittag/': 'assets/qr-minnimaker.png',
  'kidslab.de/kurse/lego-robotics/': 'assets/qr-lego.png',
  'kidslab.de/kurse/hackerwerkstatt/': 'assets/qr-hackerwerkstatt.png',
  'kidslab.de/gameslab/': 'assets/qr-gameslab.png',
  'kidslab.de/demokratie-in-minecraft/': 'assets/qr-demokratie.png',
  'kidslab.de': 'assets/qr-kidslab.png',
};

// alle genutzten Assets für Preloading
const ALL_ASSETS = [
  'assets/logo.png',
  'assets/qr-whatsapp.png',
  ...Object.values(QR_IMAGES),
  COURSES[0].image, COURSES[1].image, COURSES[2].image,
  PROJECTS[0].image, PROJECTS[1].image,
  ...GALLERY,
];

Object.assign(window, { KIDSLAB, COURSES, PROJECTS, GALLERY, VALUES, QR_IMAGES, ALL_ASSETS });
