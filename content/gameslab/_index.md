...
aliases:
  - /projekte/gameslab
  - /projekte/gameslab/mentoring
  - /projekte/gameslab/gameslab-handbuch
  - /projekte/gameslab-lehrer
cascade:
  type: docs
---

{{< img src="gameslab-logo-quer.png" width="50%" alt="GamesLab Logo" >}}
...
{{< img src="075_20231206_bbw_kidslab_stw_em220032-300x225.jpg" width="80%" alt="GamesLab Workshop — Kinder programmieren Spiele" >}}
...
{{< img src="gamespreis-gewinner.jpg" width="80%" alt="GamesPreis Gewinner auf der Bühne" >}}

{{< button href="/gameslab/gamespreis/" >}}Alle Gewinner und Spiele anspielen{{< /button >}}
...
{{< img src="gamespreis-mentoren.jpg" width="80%" alt="GamesLab Mentoren-Team" >}}
...
{{< gallery cols="3" >}}
![GamesLab App Dashboard](gameslab-app-dashboard.png)
![GamesLab App Belohnungen](gameslab-app-belohnungen.png)
![GamesLab App Lernen](gameslab-app-lernen.png)
{{< /gallery >}}
...
{{< button href="/gameslab/studio/" >}}Mehr zum GamesLab Studio{{< /button >}}
...
{{< button href="mailto:gregor@kidslab.de" >}}Kontakt: gregor@kidslab.de{{< /button >}}
...
{{< button href="mailto:gregor@kidslab.de" >}}Meld dich: gregor@kidslab.de{{< /button >}}

### Belohnungen die motivieren

{{< gallery cols="3" >}}
![Infinity Cube](infinity-cube.png)
![Pixel-Anhänger](pixl-anhaenger.jpg)
![Wackel-Dino](wackel-dino.png)
{{< /gallery >}}
...
{{< gallery cols="2" >}}
![Screenshot der GamesLab-Website](screenshot-gameslab-site.png)
![GamesLab Workshop — Schüler programmieren Spiele](bildschirmfoto-vom-2026-02-09-17-26-31.png)
![GamesLab Workshop Übersicht](width_550.png)
{{< /gallery >}}
